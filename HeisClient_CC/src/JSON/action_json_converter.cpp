...
*/
JSONSendPacket_Action ActionJsonConverter::from_json_to_packet(std::string json) const
{
...
*/
std::string ActionJsonConverter::from_packet_to_json(JSONSendPacket_Action pkt) const
{
